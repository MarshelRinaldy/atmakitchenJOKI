            ...
            <div class="container mt-4 mb-5">
                <div class="row">
                    <div class="title mt-5 mb-5">
                        <h5 style="font-size: 40px; font-weight: 600;">Konfirmasi Pembayaran</h5>
                        <h5>Total yang harus dibayar :</h5>
                        <h5>"Rp. {{ $transaksi->total_harga }}"</h5>
                        <img src="../image/bukti_pembayaran.jpeg" alt="" width="400px">
                    </div>

                    <form action="{{ route('store_pemasukan_perusahaan') }}" method="POST">
                        @csrf
                        <div class="body-input">
                            <div class="col-6">
                                <div class="label">
                                    <p class="mb-2">Input Pemasukan </p>
                                    <input name="jumlah_income" type="text" class="input" required>
                                    <p class="mb-0">Deskripsi</p>
                                    <textarea name="deskripsi" style="height: 90px;" class="input"></textarea>
